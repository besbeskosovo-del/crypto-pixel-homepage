  ...
  body: [
    ...
    H.section(
      `<h2 class="lh-h2">From us</h2><div class="grid-3 mt-6">
        ...
        <div class="lh-card"><h3 class="lh-h4">GAPP document checklist</h3><p class="lh-small mt-2">One page PDF. [CONFIRM: build]</p></div>
        <div class="lh-card"><h3 class="lh-h4">Emergency plan template</h3><p class="lh-small mt-2">For the fridge: trach, vent, G tube (PDF). [CONFIRM: build, clinical review]</p></div>
        <div class="lh-card"><h3 class="lh-h4">Medication list template</h3><p class="lh-small mt-2">PDF. [CONFIRM]</p></div>
    ...
    H.section(
      `<h2 class="lh-h2">Georgia programs</h2><ul class="lh-body mt-6">
        <li><b>Georgia Pediatric Program (GAPP)</b>, Georgia Department of Community Health. The official program page. GAPP program specialist: (404) 683-5113, GAPP.inquiries@dch.ga.gov [CONFIRM current]</li>
        ...
        <li><b>Georgia Medicaid CMO plans:</b> Amerigroup, CareSource, Peach State Health Plan [CONFIRM current names] and how to find your child’s plan.</li>
    ...
    H.section(
      `<h2 class="lh-h2">Practical</h2><ul class="lh-body mt-6">
        <li>Georgia Power and Georgia EMC medical priority programs for families with life support equipment at home [CONFIRM]</li>
        <li>Georgia 911 special needs registry, if your county has one [CONFIRM]</li>
...
const GUIDE = [
  ...
  ['the-documents', 'The documents',
   `<ul>
      ...
      <li>Medicaid forms: DMA-6A (valid for one year) and DMA-80 [CONFIRM current forms]</li>
  ...
  ['renewals', 'Renewals',
   `<p>GAPP approvals are time limited. Renewal needs an updated plan of treatment, records and forms, and the DMA-6A expires every year. We track your dates and start renewals 30 to 60 days early so hours don’t lapse. [CONFIRM]</p>`],
  ...
  ['paid-parent-caregivers', 'Paid parent caregivers',
   `<p>Georgia Medicaid allows parents and legal guardians to be paid for personal care support hours under GAPP, approved through December 31, 2029. This covers daily living care, not skilled nursing. See our <a class="lh-link" href="/families/paid-parent-caregiver">paid parent caregiver page</a>. [CONFIRM: link only if Little Hearts offers PCS]</p>`],
  ...
  ['turning-21', 'Turning 21',
   `<p>GAPP ends at 21. Adult Medicaid programs and waivers (such as the NOW and COMP waivers, or the Independent Care Waiver Program) have their own rules and waiting lists. We start the conversation with you a year ahead. [CONFIRM]</p>`],
];
    ...
    H.section(
      `<div class="article-layout">
        ...
        <div class="article-body lh-body">
          ...
          <h2 class="lh-h3" id="checklist">The one page checklist</h2>
          <p>${H.btn('Download the GAPP checklist (PDF) [CONFIRM: build]', '#checklist')}</p>
        </div>
      </div>`,
...
const FAQ_GROUPS = [
  ['Cost and GAPP', [
    ...
    ['Can I be paid to care for my child?', 'In some cases, for personal care support hours. Read <a class="lh-link" href="/families/paid-parent-caregiver">Paid parent caregiver</a>. [CONFIRM]'],
  ]],
  ['Nurses and care', [
    ...
    ['Can the nurse take my child to school or appointments?', '[CONFIRM policy.]'],
  ...
  ['Getting started', [
    ...
    ['What happens at 21?', 'GAPP ends at 21. We start planning the transition with you a year ahead. [CONFIRM]'],
  ]],
];
