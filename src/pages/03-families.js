...
const howSteps = [
  ...
  ['We build the GAPP request.',
    'We collect what Georgia Medicaid requires: the physician’s plan of treatment, medical records, the medication list and equipment details. We fill out the forms with you and get your doctor’s signature. We do this with you, personally.',
...
const howItWorks = {
  ...
  body: [
    ...
    H.section(
      ...
      <p class="lh-body mt-4 measure">Call us as soon as discharge is being discussed, even if the date isn’t set. We work with the discharge planner so the GAPP request, the equipment and the nursing schedule are ready when your child is. Hospital discharges go to the front of our calendar.</p>`,
    ...
    H.section(
      `<h2 class="lh-h2">What it’s like after the first week</h2><div class="mt-6">${H.stepGrid([
        ...
        ['Your owners', 'One number that reaches the people who run the agency. Clinical questions, paperwork, scheduling: one call covers all of it.'],
        ['Your renewals', 'GAPP approvals expire. We track the dates and start renewals early, so your child’s hours don’t lapse.'],
      ], 3)}</div>`,
  ...
  body: [
    ...
    H.section(
      `<h2 class="lh-h2">Who qualifies</h2><div class="grid-3 mt-6">
        ...
        <div class="lh-card"><h3 class="lh-h4">Your child has Georgia Medicaid.</h3><p class="lh-small mt-2">Any Georgia Medicaid plan: the CMO plans and fee for service both count.</p></div>
    ...
    H.section(
      `<h2 class="lh-h2">What GAPP pays for</h2><div class="split mt-6">
        <div><h3 class="lh-h4">Covered</h3><div class="mt-4">${H.checkList([
          ...
          'Personal care support services by an aide, in some cases including a trained parent. Ask us about your child’s case.',
        ], true)}</div></div>
    ...
    H.section(
      `<h2 class="lh-h2">What the request needs</h2><div class="mt-6">${H.checkList([
        ...
        'The current Medicaid forms (DMA-6A and DMA-80)',
    ...
    H.section(
      `<h2 class="lh-h2">How long it takes</h2><div class="mt-6">${H.stepGrid([
        ['Getting the packet together', 'Usually one to three weeks, mostly waiting on records and signatures.'],
    ...
    H.section(
      `<div class="split">
        <div><h2 class="lh-h3">Renewals</h2><p class="lh-body mt-3">GAPP approvals are time limited. Renewal needs updated orders, records and forms. We track your dates and start early.</p></div>
...
const paidParent = {
  ...
  body: [
    ...
    H.section(
      ...
      <p class="lh-small mt-2">[CONFIRM: Little Hearts enrollment to provide GAPP personal care support]</p>
    ...
    H.section(
      `<h2 class="lh-h2">How it works with us</h2><div class="mt-6">${H.stepGrid([
        ...
        ['Training', 'You complete the training and screening our agency requires for every aide.'],
        ['We employ you', 'We employ you as a caregiver and schedule you for the approved hours.'],
        ['You are paid', 'You chart the hours you work, and we pay you on our regular payroll.'],
      ])}</div>`,
    ...
    H.section(
      `<h2 class="lh-h2">Questions</h2><div class="mt-6">${H.faqGrid([
        ['Can both parents be paid?', 'Ask us. The rules on this can change, and we’ll tell you plainly what applies to your family.'],
...
const requestCare = {
  ...
  body: [
    `<section class="hero" aria-label="Introduction"><div class="inner">
      ...
      <p class="lead lh-body-lg">Fill out what you know. Skip what you don’t. An owner will call you, not a screener.</p>
      ...
      `<div class="split">
        ...
        <div class="lh-card lh-card--flat">
          ...
          <ol class="lh-body mt-4">
            <li>An owner calls you, usually by the next business day.</li>
