...
const about = {
  ...
  description: 'Little Hearts Home Care is owned and run by three people who answer their own phones. Pediatric home nursing in Georgia for children under 21.',
  ctaBand: 'standard',
  crumbs: [['About us', '/about']],
  body: [
    `<section class="hero" aria-label="Introduction"><div class="inner">
      <p class="lh-eyebrow">About Little Hearts</p>
      <h1 class="lh-h1">Three owners who answer their own phones.</h1>
      <p class="lead lh-body-lg">We started Little Hearts because families of medically complex children deserve a nursing agency small enough to reach and serious enough to trust. There are three of us. You get all three.</p>
    </div></section>`,
    H.section(
      `<div class="split">
        <div>
          <h2 class="lh-h2">Why we do this</h2>
          <p class="lh-body mt-4">[Owner story, 120 to 180 words, in the owners’ own words. Prompts: What did each of you do before this? What did you see families go through with big agencies? What was the moment you decided to start your own? Keep it plain. No “passion” or “journey”.]</p>
        </div>
        ${H.photoSlot('Owners photo', 'The three owners of Little Hearts Home Care in a family’s living room, natural light, not posed at a desk.')}
      </div>`,
      { white: true, label: 'Why we started' }),
    H.section(
      `<h2 class="lh-h2">Who you’ll talk to</h2><div class="grid-3 mt-6">${S.OWNERS.map(([name, what]) => `
        <div class="lh-card">
          ${H.photoSlot('Owner portrait', 'Portrait, natural light.', '1 / 1')}
          <h3 class="lh-h4 mt-4">${name}</h3>
          <p class="lh-small mt-2">[Two sentences: background, and what families and referrers call this owner about.] ${what}</p>
          <p class="lh-small mt-2">Direct: [phone]</p>
        </div>`).join('')}</div>`,
      { label: 'The owners' }),
    H.section(
      `<h2 class="lh-h2">How we run the agency</h2><div class="grid-4 mt-6">
        ...
        <div class="lh-card lh-card--flat"><h3 class="lh-h4">Nurses who stay.</h3><p class="lh-small mt-2">We match a nurse to your child and keep the same nurses on the case for as long as we can, so they learn your child’s baseline. [CONFIRM: continuity policy]</p></div>
        <div class="lh-card lh-card--flat"><h3 class="lh-h4">An RN supervises every case.</h3><p class="lh-small mt-2">[Owner or RN supervisor name] reviews the care plan, checks nurse competency on your child’s equipment and visits the home. [CONFIRM: supervisory visit frequency]</p></div>
    ...
    H.section(
      ...
      <p class="lh-body mt-4 measure">Little Hearts HC, LLC is licensed by the Georgia Department of Community Health as a private home care provider, license [NUMBER]. We are an enrolled Georgia Medicaid and GAPP provider [CONFIRM]. Our nurses hold active Georgia RN or LPN licenses, current BLS, background checks and health clearances. We follow HIPAA. [CONFIRM: any accreditation]</p>`,
...
const contact = {
  ...
  body: [
    `<section class="hero" aria-label="Introduction"><div class="inner">
      <h1 class="lh-h1">Call an owner. You’ll get one of us.</h1>
      <p class="lead lh-body-lg">No phone tree. No call center. Pick the person who handles your question, or call the main number and we’ll sort it out.</p>
    </div></section>`,
    H.section(
      `<div class="grid-3">${S.OWNERS.map(([name, what, phone]) => `
        <div class="lh-card">
          <h2 class="lh-h4">${name}</h2>
          <p class="lh-small mt-2">${what}</p>
          <p class="lh-body mt-3"><b>${phone}</b></p>
        </div>`).join('')}</div>`,
      { white: true, label: 'The owners' }),
    H.section(
      `<div class="split">
        <div class="lh-body">
          ...
          <b>Email:</b> hello@littleheartshc.com [CONFIRM]<br>
          <b>Office:</b> [STREET], [CITY], GA [ZIP]. By appointment.<br>
          <b>Hours:</b> [CONFIRM office hours]. After hours, families on service call their owner’s cell. [CONFIRM]</p>
  ...
  body: [
    `<section class="hero" aria-label="Introduction"><div class="inner">
      ...
      <div class="hero-actions">
        ${H.btn('Apply', '#apply')}
        ${H.link('Call [Owner, clinical lead] at [phone]', '/contact')}
      </div>
    </div></section>`,
    H.section(
      `<h2 class="lh-h2">What is actually different here</h2><div class="grid-3 mt-6">
        ...
        <div class="lh-card lh-card--flat"><h3 class="lh-h4">Owners who pick up.</h3><p class="lh-small mt-2">Three owners, all reachable. [Clinical lead name] is an RN and reviews every case. [CONFIRM]</p></div>
        <div class="lh-card lh-card--flat"><h3 class="lh-h4">Trained on the child’s equipment before shift one.</h3><p class="lh-small mt-2">We check your competency on the actual vent, pump or trach setup in the home. Paid. [CONFIRM]</p></div>
        <div class="lh-card lh-card--flat"><h3 class="lh-h4">Pay that matches the case.</h3><p class="lh-small mt-2">Hourly rates by license, experience and acuity. Trach and vent cases pay more. We tell you the rate before you accept a case. [CONFIRM rate ranges to publish, or leave unpublished]</p></div>
    ...
    H.section(
      `<div class="split" id="shift">
        <div>
          ...
          <p class="lh-body mt-4">You arrive and get report from the parent or the nurse going off. You check the equipment and the emergency kit. You follow the plan of care: feeds, meds, suction, vent checks, therapies the family does at home, and the ordinary parts of a kid’s day. You chart as you go in [CONFIRM: EHR name]. If something changes, you call the RN supervisor, then the family’s doctor if needed. You give report at the end. Nights are quieter but you stay awake and alert. [CONFIRM night shift rules]</p>
        </div>
    ...
    H.section(
      ...
      <ul class="lh-body mt-6">
        ...
        <li>[CONFIRM: any office or coordinator roles]</li>
      </ul>
    ...
    H.section(
      `<div class="split">
        <div><h2 class="lh-h3">Requirements</h2><ul class="lh-body mt-4">
          <li>Active, unrestricted Georgia RN or LPN license (compact accepted for RNs) [CONFIRM]</li>
          <li>Current BLS. PALS a plus. [CONFIRM]</li>
          <li>Background check, drug screen, TB test and health clearances [CONFIRM list]</li>
        ...
        <div><h2 class="lh-h3">What you get</h2><div class="mt-4">${H.checkList([
          'Hourly pay by license, experience and acuity [CONFIRM]',
          'Schedule you choose, cases near you',
          'Paid competency training on the child’s equipment [CONFIRM]',
          'An RN supervisor and an owner on call [CONFIRM hours]',
          'Continuity: the same child and family, shift after shift',
          '[CONFIRM: benefits, PTO, 401k, referral bonus]',
        ], true)}</div></div>
      </div>`,
